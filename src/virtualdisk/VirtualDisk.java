 ...
 *
 *
 *	TODO: CREATE A QUEUE OF WRITES/READS TO DO - allowed to reorder them as desired
 */
...
public abstract class VirtualDisk implements IVirtualDisk {
	...
	private void formatStore() {
		System.out.println("Emptying disk of old content, be patient...");
		...
		System.out.println("Cleared out disk.");
	}
